...
// components/StrategicCouncilPanel.tsx
import React from 'react';
import { useLocalization } from '../context/AuraContext.tsx';
import { useModal } from '../context/ModalContext.tsx';
import { personas } from '../state/personas';

const specialistIds = ['gamemaster', 'machiavelli', 'sun_tzu', 'judge'];

export const StrategicCouncilPanel = () => {
    ...
    const handleConsult = () => {
        modal.open('brainstorm', { 
            initialTopic: "Strategic Analysis: ",
