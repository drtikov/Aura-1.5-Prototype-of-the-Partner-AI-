...
// components/FuturesCouncilPanel.tsx
import React from 'react';
import { useLocalization } from '../context/AuraContext.tsx';
import { useModal } from '../context/ModalContext.tsx';
import { personas } from '../state/personas';

const specialistIds = ['oracle', 'strategist', 'visionary'];

export const FuturesCouncilPanel = () => {
    ...
    const handleConsult = () => {
        modal.open('brainstorm', { 
            initialTopic: "Future Scenario Planning: ",
