...
// components/AgencyOfCoCreationPanel.tsx
import React from 'react';
import { useLocalization } from '../context/AuraContext.tsx';
import { useModal } from '../context/ModalContext.tsx';
import { personas } from '../state/personas';

const specialistIds = ['liaison', 'automator', 'artificer', 'curator', 'advocate', 'synthesizer', 'enabler'];

export const AgencyOfCoCreationPanel = () => {
    ...
    const handleConsult = () => {
        modal.open('brainstorm', { 
            initialTopic: "Co-Creation Project: ",
    ...
    return (
        <div className="side-panel">
            <p className="reason-text" style={{ fontStyle: 'italic', color: 'var(--text-muted)', marginBottom: '1rem' }}>
                {t('agencyOfCoCreation_description')}
            </p>
